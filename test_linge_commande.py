...
def test_single_night_stay_is_a_full_change():
    ...
    qty = lc.compute_needs_from_bookings(
        bookings, datetime.date(2026, 9, 13), datetime.date(2026, 9, 19)
    )
...
def test_sans_bain_zeroes_bathroom_articles_but_keeps_bed_linen():
    ...
    qty = lc.compute_needs_from_bookings(
        bookings, datetime.date(2026, 9, 13), datetime.date(2026, 9, 19), sans_bain=True
    )
...
def test_sans_tapis_zeroes_only_tapis():
    ...
    qty = lc.compute_needs_from_bookings(
        bookings, datetime.date(2026, 9, 13), datetime.date(2026, 9, 19), sans_tapis=True
    )
